...
public class DataFactory {
	...
	public static List<Purchase> produce() {
		...
		final Client client2 = new Client("client2", "Marta", "Romańczuk", BigInteger.valueOf(62063073633L), "Szczecin");
		final Client client3 = new Client("client3", "Andrzej", "Stefański", BigInteger.valueOf(62051084215L), "Kraków");
		final Client client4 = new Client("client4", "Krystyna", "Baranowska", BigInteger.valueOf(65073073798L), "Warszawa");
		final Client client5 = new Client("client5", "Marcin", "Sadowski", BigInteger.valueOf(68071193875L), "Poznań");
		final Client client6 = new Client("client6", "Monika", "Radomska", BigInteger.valueOf(68042182821L), "Szczecin");
		final Client client7 = new Client("client7", "Tadeusz", "Stefański", BigInteger.valueOf(92052325758L), "Kraków");
		final Client client8 = new Client("client8", "Marta", "Nowak", BigInteger.valueOf(62042135735L), "Kraków");
		final Client client9 = new Client("client9", "Marcin", "Kowalski", BigInteger.valueOf(72070729244L), "Warszawa");
		...
		final Product product3 = new Product("product3", "Basen", Product.Category.GARDEN, new Money(new BigDecimal("10.99"), Money.Currency.EUR));
		final Product product4 = new Product("product4", "Lampa", Product.Category.GARDEN, new Money(new BigDecimal("9.99"), Money.Currency.EUR));
		final Product product5 = new Product("product5", "Grabki", Product.Category.GARDEN, new Money(new BigDecimal("12.99"), Money.Currency.PLN));

		final Product product6 = new Product("product6", "Koło", Product.Category.AUTOMOTIVE, new Money(new BigDecimal("13.99"), Money.Currency.PLN));
		final Product product7 = new Product("product7", "Kierownica", Product.Category.AUTOMOTIVE, new Money(new BigDecimal("18.99"), Money.Currency.PLN));
		final Product product8 = new Product("product8", "Dywanik", Product.Category.AUTOMOTIVE, new Money(new BigDecimal("19.99"), Money.Currency.PLN));
		final Product product9 = new Product("product9", "Fotel", Product.Category.AUTOMOTIVE, new Money(new BigDecimal("20.99"), Money.Currency.EUR));
		final Product product10 = new Product("product10", "Szyba", Product.Category.AUTOMOTIVE, new Money(new BigDecimal("9.99"), Money.Currency.EUR));
		final Product product11 = new Product("product11", "Skrobaczka", Product.Category.AUTOMOTIVE, new Money(new BigDecimal("11.99"), Money.Currency.EUR));

		final Product product12 = new Product("product12", "Koszulka", Product.Category.CLOTHES, new Money(new BigDecimal("26.99"), Money.Currency.PLN));
		final Product product13 = new Product("product13", "Garnitur", Product.Category.CLOTHES, new Money(new BigDecimal("92.99"), Money.Currency.PLN));
		final Product product14 = new Product("product14", "Spodnie", Product.Category.CLOTHES, new Money(new BigDecimal("14.99"), Money.Currency.PLN));
		final Product product15 = new Product("product15", "Spodnie", Product.Category.CLOTHES, new Money(new BigDecimal("72.99"), Money.Currency.EUR));
		final Product product16 = new Product("product16", "Koszula", Product.Category.CLOTHES, new Money(new BigDecimal("16.99"), Money.Currency.EUR));
		final Product product17 = new Product("product17", "Spódnica", Product.Category.CLOTHES, new Money(new BigDecimal("16.99"), Money.Currency.EUR));
		final Product product18 = new Product("product18", "Buty", Product.Category.CLOTHES, new Money(new BigDecimal("23.99"), Money.Currency.EUR));

		final Product product19 = new Product("product19", "Gra planszowa", Product.Category.HOBBY, new Money(new BigDecimal("26.99"), Money.Currency.PLN));
		final Product product20 = new Product("product20", "Karty", Product.Category.HOBBY, new Money(new BigDecimal("72.99"), Money.Currency.PLN));
		final Product product21 = new Product("product21", "Piłka", Product.Category.HOBBY, new Money(new BigDecimal("16.99"), Money.Currency.PLN));
		final Product product22 = new Product("product22", "Gazeta", Product.Category.HOBBY, new Money(new BigDecimal("62.99"), Money.Currency.EUR));
		final Product product23 = new Product("product23", "Słuchawki", Product.Category.HOBBY, new Money(new BigDecimal("62.99"), Money.Currency.PLN));
		final Product product24 = new Product("product24", "Konsola", Product.Category.HOBBY, new Money(new BigDecimal("15.99"), Money.Currency.PLN));
		final Product product25 = new Product("product25", "Książka", Product.Category.HOBBY, new Money(new BigDecimal("19.99"), Money.Currency.EUR));
